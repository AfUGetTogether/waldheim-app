  ...
  return (
    <main className="p-4 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        ...
        <Link href="/admin/verbindungen" className="block bg-white p-6 rounded-2xl shadow hover:shadow-lg hover:bg-emerald-50 transition">
          <h2 className="text-xl font-semibold mb-2">🚉 Verbindungen</h2>
          <p className="text-gray-600">ÖPNV-Verbindungen verwalten</p>
        </Link>
